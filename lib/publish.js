...
module.exports = async (pluginConfig, context) => {
  ...
  const {githubToken, githubUrl, githubApiPathPrefix, proxy, assets, draft, prerelease} = resolveConfig(
    pluginConfig,
    context
  );
  ...
  const release = {
    owner,
    repo,
    tag_name: gitTag, // eslint-disable-line camelcase
    name: gitTag,
    target_commitish: branch, // eslint-disable-line camelcase
    body: notes,
    draft,
    prerelease,
  };
