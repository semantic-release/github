...
export default async function fail(pluginConfig, context, { Octokit }) {
  ...
  if (failComment === false || failTitle === false) {
    ...
    logger.warn(`DEPRECATION: 'false' for 'failComment' or 'failTitle' is deprecated and will be removed in a future major version. Use 'failCommentCondition' instead.`);
