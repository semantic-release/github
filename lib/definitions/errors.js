...
export function EMISMATCHGITHUBURL({ repositoryUrl, git_url }) {
  return {
...
Your configuration for the \`repositoryUrl\` option is \`${stringify(repositoryUrl)}\` and the \`git_url\` of your GitHub repo is \`${stringify(git_url)}\`.
