...
| `skipPermissionsCheck`| Skips GitHub token permissions check in `verifyConditions` step. This is useful if you are using GitHub App installation tokens.                                                                       | `false`                                                                                                                                              |
